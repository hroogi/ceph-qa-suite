...
vc.disconnect()
    ...
    def test_lifecycle(self):
        ...
        # global: df should see all the writes.  This is a > rather than a
        # == because the global spaced used includes all pools
        ...
        # volume: df should see the one megabyte consumed from quota, same
        ...
        self.wait_until_equal(
                lambda: self.mount_a.getfattr(
                    os.path.join("volumes", group_id, volume_id),
                    "ceph.dir.rbytes"),
